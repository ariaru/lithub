class DocumentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @document.update(document_params)
        format.html { redirect_to branch_document_url(@branch, @document), notice: 'Document was successfully updated.' }
  ...
  private
    ...
    def document_params
      params.require(:document).permit(:title, :id, revisions_attributes: [:root, :parent_id, :summary, :body, :tags, :commit_message, :status, :document_id])
    end
end
